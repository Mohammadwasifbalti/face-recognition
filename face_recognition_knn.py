...
def show_prediction_labels_on_image(img, predictions):
    ...
    for name, (top, right, bottom, left) in predictions:
        ...
        cv2.rectangle(img,(left, bottom - text_height - 20), (right, bottom),color,2)
        cv2.putText(img, name, (left + 6, bottom - text_height+4), cv2.FONT_HERSHEY_SIMPLEX, 1, color, 1, cv2.LINE_AA)
